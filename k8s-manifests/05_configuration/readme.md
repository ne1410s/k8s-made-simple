...
Run the following in order. Wait 20s or so between each:
  - kubectl apply -f "<REPO>\k8s-manifests\05_configuration\stage01"
  - kubectl apply -f "<REPO>\k8s-manifests\05_configuration\stage02"
...
Install loki via helm:
  - helm upgrade --install loki --namespace monitoring --values "<REPO>\k8s-manifests\05_configuration\stage03_helm\loki-helm-values.yaml" grafana/loki
